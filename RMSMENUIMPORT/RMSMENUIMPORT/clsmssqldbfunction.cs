...
namespace RMSMENUIMPORT
{
    class clsmssqldbfunction
    {
        ...
        //Converts the DataGridView to DataTable Only Visible
        public DataTable DataGridView2DataTable2Visible(DataGridView dgv, String tblName, int minRow = 0)
        {
            DataTable dt = new DataTable(tblName);
            ...
            {
                MessageBox.Show(ex.Message.ToString() + " Error occures in DataGridView2DataTable2Visible())");
                return dt;
            }
        }
